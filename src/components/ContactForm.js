...
<header >
      <div
        className='p-5  hero-text  bg-image  header-img'
    
   >
         <h1 className="h1-header mt-3 ">
            Contact us
          </h1>
          <p>
    ...
    <h3 className="h3-header mt-2">Contact us</h3>
            ...
            <div className='col-6 text-center'>
              <div className='contactForm'>
                <form id='contact-form' onSubmit={handleSubmit(onSubmit)} noValidate>
                  ...
                  <button  data-bs-toggle="modal" data-bs-target="#myModal"   className='submit-btn' disabled={disabled} type='submit'>
                    Send
                  </button>
