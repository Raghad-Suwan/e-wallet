  ...
  return (
    <div>
        <h1 className="bills">PAYMENT OF BILLS SERVICE </h1>
          ...
          <p className="paybill">With this service, you will save time and effort. You will not need to go <br></br>
           to service companies and stand in line waiting for your turn to pay your bill or for private services<br></br>
          </p> 
    </div>
  )
}
