  ...
  return (
    <div>
        <h1 className="bills">PAYMENT OF BILLS SERVICE </h1>
          ...
          <p className="paybill">With this service, you will save time and effort. You will not need to go to</p>
          <p className="paybill">service companies and stand in line waiting for your turn to pay your bill or for </p>
          <p className="paybill">private services</p> 
    </div>
  )
}
