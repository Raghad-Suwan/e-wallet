...
export default function Stepstopayingmarchent () {
 ...
 <ul>
    ...
    <li>TUse any promotional code if available</li>
    <li>Confirm the transaction</li>
    <li>You will receive confirmation that the transaction was successful and a copy of the receipt </li>
    <li>You will also receive an SMS showing the transaction information
  </li>
 </ul>
